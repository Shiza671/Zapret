...
set DISCORD_IPSET_PATH=%~dp0..\lists\ipset-discord1.txt
...
--wf-tcp=80,443 --wf-udp=443,590-1400,50000-50099 ^
--filter-udp=590-1400 --ipset="%~dp0files\ipset-telegram.txt" --filter-l7=stun --dpi-desync=fake
